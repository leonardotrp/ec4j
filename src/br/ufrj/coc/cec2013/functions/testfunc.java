...
import br.ufrj.coc.cec2014.functions.testmain;
...
public class testfunc {
	...
	void test_func(double[] x, double[] f, int nx, int mx,int func_num)throws Exception{
		...
		if (ini_flag==0) /* initiailization*/
		{
			...
			for (i = 0; i < mx; i++)
			{
				...
				{
				case 1:	
					f[i] = sphere_func(t,0.0,nx,OShift,M,1);
					f[i]+=-1400.0;
					break;
				case 2:	
					f[i] = ellips_func(t,0.0,nx,OShift,M,1);
					f[i]+=-1300.0;
					break;	
				case 3:	
					f[i]=bent_cigar_func(t,0.0,nx,OShift,M,1);
					f[i]+=-1200.0;
					break;
				case 4:	
					f[i]=discus_func(t,0.0,nx,OShift,M,1);
					f[i]+=-1100.0;
					break;
				case 5:
					f[i]=dif_powers_func(t,0.0,nx,OShift,M,0);
					f[i]+=-1000.0;
					break;
				case 6:
					f[i]=rosenbrock_func(t,0.0,nx,OShift,M,1);
					f[i]+=-900.0;
					break;
				case 7:	
					f[i]=schaffer_F7_func(t,0.0,nx,OShift,M,1);
					f[i]+=-800.0;
					break;
				case 8:	
					f[i]=ackley_func(t,0.0,nx,OShift,M,1);
					f[i]+=-700.0;
					break;
				case 9:	
					f[i]=weierstrass_func(t,0.0,nx,OShift,M,1);
					f[i]+=-600.0;
					break;
				case 10:	
					f[i]=griewank_func(t,0.0,nx,OShift,M,1);
					f[i]+=-500.0;
					break;
				case 11:	
					f[i]=rastrigin_func(t,0.0,nx,OShift,M,0);
					f[i]+=-400.0;
					break;
				case 12:	
					f[i]=rastrigin_func(t,0.0,nx,OShift,M,1);
					f[i]+=-300.0;
					break;
				case 13:	
					f[i]=step_rastrigin_func(t,0.0,nx,OShift,M,1);
					f[i]+=-200.0;
					break;
				case 14:	
					f[i]=schwefel_func(t,0.0,nx,OShift,M,0);
					f[i]+=-100.0;
					break;
				case 15:	
					f[i]=schwefel_func(t,0.0,nx,OShift,M,1);
					f[i]+=100.0;
					break;
				case 16:	
					f[i]=katsuura_func(t,0.0,nx,OShift,M,1);
					f[i]+=200.0;
					break;
				case 17:	
					f[i]=bi_rastrigin_func(t,0.0,nx,OShift,M,0);
					f[i]+=300.0;
					break;
				case 18:	
					f[i]=bi_rastrigin_func(t,0.0,nx,OShift,M,1);
					f[i]+=400.0;
					break;
				case 19:	
					f[i]=grie_rosen_func(t,0.0,nx,OShift,M,1);
					f[i]+=500.0;
					break;
				case 20:	
					f[i]=escaffer6_func(t,0.0,nx,OShift,M,1);
					f[i]+=600.0;
					break;
				case 21:	
					f[i]=cf01(t,0.0,nx,OShift,M,1);
					f[i]+=700.0;
					break;
				case 22:	
					f[i]=cf02(t,0.0,nx,OShift,M,0);
					f[i]+=800.0;
					break;
				case 23:	
					f[i]=cf03(t,0.0,nx,OShift,M,1);
					f[i]+=900.0;
					break;
				case 24:	
					f[i]=cf04(t,0.0,nx,OShift,M,1);
					f[i]+=1000.0;
					break;
				case 25:	
					f[i]=cf05(t,0.0,nx,OShift,M,1);
					f[i]+=1100.0;
					break;
				case 26:
					f[i]=cf06(t,0.0,nx,OShift,M,1);
					f[i]+=1200.0;
					break;
				case 27:
					f[i]=cf07(t,0.0,nx,OShift,M,1);
					f[i]+=1300.0;
					break;
				case 28:
					f[i]=cf08(t,0.0,nx,OShift,M,1);
					f[i]+=1400.0;
					break;
				default:
	...
	public double exec_func(double[] x_in, int dim, int func_num) throws Exception {
		...
		{
		case 1:	
			f_out = sphere_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-1400.0;
			break;
		case 2:	
			f_out = ellips_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-1300.0;
			break;	
		case 3:	
			f_out=bent_cigar_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-1200.0;
			break;
		case 4:	
			f_out=discus_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-1100.0;
			break;
		case 5:
			f_out=dif_powers_func(x_in,0.0,dim,OShift,M,0);
			f_out+=-1000.0;
			break;
		case 6:
			f_out=rosenbrock_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-900.0;
			break;
		case 7:	
			f_out=schaffer_F7_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-800.0;
			break;
		case 8:	
			f_out=ackley_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-700.0;
			break;
		case 9:	
			f_out=weierstrass_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-600.0;
			break;
		case 10:	
			f_out=griewank_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-500.0;
			break;
		case 11:	
			f_out=rastrigin_func(x_in,0.0,dim,OShift,M,0);
			f_out+=-400.0;
			break;
		case 12:	
			f_out=rastrigin_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-300.0;
			break;
		case 13:	
			f_out=step_rastrigin_func(x_in,0.0,dim,OShift,M,1);
			f_out+=-200.0;
			break;
		case 14:	
			f_out=schwefel_func(x_in,0.0,dim,OShift,M,0);
			f_out+=-100.0;
			break;
		case 15:	
			f_out=schwefel_func(x_in,0.0,dim,OShift,M,1);
			f_out+=100.0;
			break;
		case 16:	
			f_out=katsuura_func(x_in,0.0,dim,OShift,M,1);
			f_out+=200.0;
			break;
		case 17:	
			f_out=bi_rastrigin_func(x_in,0.0,dim,OShift,M,0);
			f_out+=300.0;
			break;
		case 18:	
			f_out=bi_rastrigin_func(x_in,0.0,dim,OShift,M,1);
			f_out+=400.0;
			break;
		case 19:	
			f_out=grie_rosen_func(x_in,0.0,dim,OShift,M,1);
			f_out+=500.0;
			break;
		case 20:	
			f_out=escaffer6_func(x_in,0.0,dim,OShift,M,1);
			f_out+=600.0;
			break;
		case 21:	
			f_out=cf01(x_in,0.0,dim,OShift,M,1);
			f_out+=700.0;
			break;
		case 22:	
			f_out=cf02(x_in,0.0,dim,OShift,M,0);
			f_out+=800.0;
			break;
		case 23:	
			f_out=cf03(x_in,0.0,dim,OShift,M,1);
			f_out+=900.0;
			break;
		case 24:	
			f_out=cf04(x_in,0.0,dim,OShift,M,1);
			f_out+=1000.0;
			break;
		case 25:	
			f_out=cf05(x_in,0.0,dim,OShift,M,1);
			f_out+=1100.0;
			break;
		case 26:
			f_out=cf06(x_in,0.0,dim,OShift,M,1);
			f_out+=1200.0;
			break;
		case 27:
			f_out=cf07(x_in,0.0,dim,OShift,M,1);
			f_out+=1300.0;
			break;
		case 28:
			f_out=cf08(x_in,0.0,dim,OShift,M,1);
			f_out+=1400.0;
			break;
		default:
			System.out.println("\nError: There are only 28 test functions in this test suite!");
	...
	public void loadConstants(int nx, int func_num) throws Exception {
		int cf_num = 10;
		int i;
		y=new double[nx];
		z=new double[nx];
		...
		URL urlInputM = testfunc.getInputData("M_D" + nx + ".txt");
		...
		URL urlInputShiftData = testfunc.getInputData("shift_data.txt");
