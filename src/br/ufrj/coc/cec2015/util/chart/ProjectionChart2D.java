...
public class ProjectionChart2D extends JFrame {
	...
	private ChartPanel createProjectionsPanel() {
		JFreeChart jfreechart = ChartFactory.createScatterPlot(DEFAULT_CHART_TITLE, "X (IndivÃ­duo . V1)", "Y (IndivÃ­duo . V2)", createSampleData(), PlotOrientation.VERTICAL, true, true, true);
