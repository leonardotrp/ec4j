package br.ufrj.coc.base.functions;
/*
...
public class testfunc {
	...
	public double exec_func(double[] x_in, int dim, int func_num) throws Exception {
		...
		{
		case 1:	
			f_out=rosenbrock_func(x_in,0.0,dim,OShift,M,1,1); // -30, 30
			f_out+=0.0;
			break;
		case 2:
		...
		case 2:	
			...
			break;
		case 3:	
			f_out=discus_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=300.0;
			break;
		case 4:	
			f_out=rosenbrock_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=400.0;
			break;
		case 6:
			f_out=weierstrass_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=600.0;
			break;
		case 7:	
			f_out=griewank_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=700.0;
			break;
		case 8:	
			f_out=rastrigin_func(x_in,0.0,dim,OShift,M,1,0);
			f_out+=800.0;
			break;
		case 9:	
			...
			break;
		case 10:	
			f_out=schwefel_func(x_in,0.0,dim,OShift,M,1,0);
			f_out+=1000.0;
			break;
		case 11:	
			...
			break;
		case 12:	
			f_out=katsuura_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=1200.0;
			break;
		case 13:	
			f_out=happycat_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=1300.0;
			break;
		case 14:	
			f_out=hgbat_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=1400.0;
			break;
		case 15:	
			f_out=grie_rosen_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=1500.0;
			break;
		case 16:	
			f_out=escaffer6_func(x_in,0.0,dim,OShift,M,1,1);
			f_out+=1600.0;
			break;
		case 17:	
		...
		case 19:	
			...
			break;
		case 20:	
			f_out=hf04(x_in,0.0,dim,OShift,M,SS,1,1);
			f_out+=2000.0;
			break;
		case 21:	
			f_out=hf05(x_in,0.0,dim,OShift,M,SS,1,1);
			f_out+=2100.0;
			break;
		case 22:	
			f_out=hf06(x_in,0.0,dim,OShift,M,SS,1,1);
			f_out+=2200.0;
			break;
		case 23:	
			...
			break;
		case 24:	
			f_out=cf02(x_in,0.0,dim,OShift,M,1);
			f_out+=2400.0;
			break;
		case 25:	
		...
		case 28:
			...
			break;
		case 29:
			f_out=cf07(x_in,0.0,dim,OShift,M,SS,1);
			f_out+=2900.0;
			break;
		case 30:
			f_out=cf08(x_in,0.0,dim,OShift,M,SS,1);
			f_out+=3000.0;
			break;
		*/
		default:
